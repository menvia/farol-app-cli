    ...
    return __generator(this, function (_a) {
        if (!fs.existsSync(farolConfigFilePath)) {
            ...
            if (farolConfig.platform === 'web') {
                ...
                possibleNakedArguments_1 = ['offline', 'retry'];
                args = args.map(function (arg) {
                    return possibleNakedArguments_1.some(function (nakedArg) { return nakedArg === arg; })
                        ? arg + ":"
                        : arg;
                });
                params = ['exec', 'fastlane'].concat(args);
